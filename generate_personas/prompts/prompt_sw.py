...
1.  **핵심 인사이트 및 인구통계 파악**:
    * 현재 세그먼트의 '### PERSONA METADATA ###', 위 '### 컨텍스트 ###' 와 '###각 제품 정보###'를 기반으로 이 세그먼트를 가장 잘 나타내는 특징들을 파악합니다.
    * 'meta_profile'에 명시된 '성별', '연령대', '가구소득', '가구원수' 등 핵심 인구통계와 **기존사용제품**을 바탕으로 페르소나의 기본 배경으로 설정하고, 이로부터 예상되는 라이프스타일 가설을 세웁니다.
